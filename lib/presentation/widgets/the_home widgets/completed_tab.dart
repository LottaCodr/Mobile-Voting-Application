...
import 'package:mobile_voting_application/presentation/widgets/the_home widgets/tab_cards/completed_card.dart';
        ...
        children: [
          SizedBox(
            ...
            child: PageView.builder(
                ...
                itemCount: completedElection.length,
                itemBuilder: (context, position) {
                  return CompletedCard(
                    index: position,
                    completed: completedElection[position],
          ...
          DotsIndicator(
            dotsCount: completedElection.length,
          ...
          Container(
            ...
            decoration: BoxDecoration(
                border: Border.all(color: MVAColors.primaryColor),
                color: Colors.white,
